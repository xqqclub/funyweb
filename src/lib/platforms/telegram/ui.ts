...
export const commandMap: Record<string, CommandTarget> = {
  ...
  "工作中": { status: "working" },
  "/companymeal": { status: "company_eating" },
  "/lunchatwork": { status: "company_eating" },
  "公司吃飯": { status: "company_eating" },
  "/fieldwork": { status: "field_work" },
  "/outsidework": { status: "field_work" },
  "外出工作": { status: "field_work" },
  ...
  "在家吃飯": { status: "at_home", homeMode: "eating" },
